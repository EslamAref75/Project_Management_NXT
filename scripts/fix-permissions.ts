...
async function main() {
    ...
    console.log('\n⚠️  IMPORTANT: You should also update prisma/seed.ts to use getAllPermissions()')
    console.log('   to prevent this issue from happening again when you run npm run seed.')
